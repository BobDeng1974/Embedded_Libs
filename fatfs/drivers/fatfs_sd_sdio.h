...
#define __HAL_RCC_SDMMCx_CLK_ENABLE         __HAL_RCC_SDMMC2_CLK_ENABLE
#define __HAL_RCC_SDMMCx_CLK_DISABLE        __HAL_RCC_SDMMC2_CLK_DISABLE
#define SDMMCx_GPIO_AF                      GPIO_AF10_SDMMC2
